...
import stop from './song/song.mp3';
import bg from './videos/car.mp4';
import git from './images/git2.png';

function App() {
  const [viewCount, setViewCount] = useState(6969);
  ...
  // Typewriter effect
  const [bioText, setBioText] = useState("Testing this template out lolz");
  ...
  return (
    <div className='app-container'>
      ...
      <div className={`main-container ${entered ? 'entered' : ''}`}>
        ...
        <div className='info' >
          <h1 className='name'>hoz</h1>
          <h1 className='bio'>{bio}</h1> {/* Bio with typewriter effect */}
        </div>
        <div className='links'>
          <a href="https://twitter.com/dx9hoz" target="_blank" rel="noopener noreferrer">
            <img src={twitter} className='link1' alt="Twitter" />
          </a>
          <a href="https://github.com/hoz7" target="_blank" rel="noopener noreferrer">
            <img src={git} className='link2' alt="GitHub" />
          </a>
          <a href="https://www.youtube.com/channel/UC41_RcGvmkZfVMhy2MeL8iA" target="_blank" rel="noopener noreferrer">
            <img src={yt} className='link4' alt="YouTube" />
          </a>
          <a href="https://discord.com/users/1025027832960786484" target="_blank" rel="noopener noreferrer">
        ...
        <div className='song'>
          ...
          <a href='https://www.youtube.com/watch?v=9N2LzFrsew4' target='_blank' rel='noopener noreferrer'>
            <img src={cover} className='songcover' alt='' />
          </a>
          <div className='songinfo'>
            <p1 className='songtitle'>Kankan - Wokeup</p1>
